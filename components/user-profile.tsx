...
export function UserProfile() {
    ...
    if (config?.authNextAuth?.enabled) {
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56">
                ...
                { config?.authNextAuth?.enabled &&
                    (
                        <button 
                            className="flex items-center gap-3.5 px-2 py-3 text-red text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
